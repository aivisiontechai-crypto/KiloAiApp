#!/usr/bin/env python3
"""MailAI - Payment Processor"""
import os, stripe
stripe.api_key = os.getenv("STRIPE_API_KEY", "")
PRICES = {"pro": 900, "business": 2900}
    ...
    def create_checkout(self, user_id: int, plan: str) -> str:
        ...
        try:
            session = stripe.checkout.Session.create(
                ...
                line_items=[{"price_data": {"currency": "usd", "product_data": {"name": f"MailAI {plan.title()}"}, "unit_amount": PRICES.get(plan, 900), "recurring": {"interval": "month"}}, "quantity": 1}],
